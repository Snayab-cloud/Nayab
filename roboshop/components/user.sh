...
sed -i -e 's/MONGO_DNSNAME/mongodb-ss.shaik.cf/' -e 's/REDIS_ENDPOINT/redis-ss.shaik.cf/' /home/roboshop/user/systemd.service && mv /home/roboshop/user/systemd.service /etc/systemd/system/user.service
stat $?
